...
class Password {
	...
	public static function check($password, $hash) {
		return StringUtil::compare(crypt($password, $hash), $hash);
	}
	 ...
	 * use the `'encode'` option of `StringUtil::random()` because it could result in 2 bits less of
	...
	protected static function _genSaltXDES($count = null) {
		...
		$output .= StringUtil::random(3, array('encode' => StringUtil::ENCODE_BASE_64));
